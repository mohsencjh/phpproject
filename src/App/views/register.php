...
<section class="max-w-2xl mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            <span class="text-gray-700">سن</span>
        ...
        <label class="block">
            <span class="text-gray-700">کشور</span>
        ...
        <label class="block">
            <span class="text-gray-700">لینک شبکه اجتماعی</span>
        ...
        <label class="block">
            <span class="text-gray-700">رمزعبور</span>
        ...
        <label class="block">
            <span class="text-gray-700">تکرار رمز عبور</span>
            ...
            <div class="mt-2">
                <div>
                    <label class="inline-flex items-center">
                        ...
                        <span class="ml-2">من تمامی شرایط و قوانین سایت را می پذیرم.</span>
                    </label>
